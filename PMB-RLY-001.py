...
PCA9538_CMD_Input              = b'\xFF'
PCA9538_Output_FF              = b'\xFF'
PCA9538_Output_00              = b'\x00'
...
def setup():
    ...
    i2c.writeto_mem(PCA9538_I2C_ADDRESS , PCA9538_OUT_REG , PCA9538_Output_FF )
    time.sleep_us(5)
    print('Setup Done.')
###############################################################################
...
while(True):
    if Control == "Single":
    #for i in range(4):    
        i2c.writeto_mem(PCA9538_I2C_ADDRESS, PCA9538_OUT_REG , Relay_1_ON )
        sleep(1)
        i2c.writeto_mem(PCA9538_I2C_ADDRESS, PCA9538_OUT_REG , Relay_2_ON)
        sleep(1)
        i2c.writeto_mem(PCA9538_I2C_ADDRESS, PCA9538_OUT_REG , Relay_3_ON)
        sleep(1)
        i2c.writeto_mem(PCA9538_I2C_ADDRESS, PCA9538_OUT_REG , Relay_4_ON)
        sleep(1)
        i2c.writeto_mem(PCA9538_I2C_ADDRESS, PCA9538_OUT_REG , Relay_5_ON)
        sleep(1)
        i2c.writeto_mem(PCA9538_I2C_ADDRESS, PCA9538_OUT_REG , Relay_6_ON)
        sleep(1)
        i2c.writeto_mem(PCA9538_I2C_ADDRESS, PCA9538_OUT_REG , Relay_7_ON)
        sleep(1)
        i2c.writeto_mem(PCA9538_I2C_ADDRESS, PCA9538_OUT_REG , Relay_8_ON)
        sleep(1)
        
    if Control == "All":
       
        i2c.writeto_mem(PCA9538_I2C_ADDRESS, PCA9538_OUT_REG , PCA9538_Output_00)
        sleep(2)
        i2c.writeto_mem(PCA9538_I2C_ADDRESS, PCA9538_OUT_REG , PCA9538_Output_FF)
        sleep(2)
